...
public class CourseVideo implements CustomDomain<CourseVideo> {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "courseVideo_id_seq")
    @SequenceGenerator(name = "courseVideo_id_seq", allocationSize = 1, sequenceName = "courseVideo_id_seq", initialValue = 1)
    @Column(name = "\"id\"")
    ...
    public Object clone() throws CloneNotSupportedException {
        CourseVideo entity = (CourseVideo)super.clone();
        entity.setId(null);
        return entity;
    }
}