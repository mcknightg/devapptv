package com.bluntsoftware.devapptv.modules.user_manager.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "user_manager_EntityManagerFactory",
                         transactionManagerRef = "user_manager_TransactionManager",
                                  basePackages = {"com.bluntsoftware.devapptv.modules.user_manager.repository"},
...
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan( "com.bluntsoftware.devapptv.modules.user_manager.domain" );
